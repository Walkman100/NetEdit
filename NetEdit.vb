...
Partial Public Class NetEdit
    ...
    Sub PopulateNetworkList() Handles btnConnRefresh.Click
        ...
        For Each connectedNetwork In GetNetworks()
            tmpListViewItem = New ListViewItem(New String() {connectedNetwork.Name, connectedNetwork.InterfaceAlias,
        ...
        For Each profile In GetProfileSignatures()
            ...
            If assignedSignature = False Then ' no profile with the same GUID, add a new entry
                tmpListViewItem = New ListViewItem(New String() {"", "", "", "", "", "",
                    BitConverter.ToString(profile.SignatureDefaultGatewayMac).Replace("-", ":"), profile.SignatureDNSSuffix, profile.SignatureDescription,
    ...
    Sub SetKey(keyPath As String, value As String, data As Object)
        ...
        ElseIf writeToRegFile = True Then
    ...
    Sub btnAll_AllButtons_MouseUp(sender As Object, e As MouseEventArgs) Handles btnAllName.MouseUp, btnAllCategory.MouseUp, btnAllDescription.MouseUp, btnAllManaged.MouseUp,
            btnAllNameType.MouseUp, btnAllCategoryType.MouseUp, btnAllDeleteProfile.MouseUp, btnAllSignatureGateway.MouseUp, btnAllSignatureDNS.MouseUp, btnAllDescription.MouseUp,
    ...
    End Sub
    Sub btnAll_AllButtons_KeyDown(sender As Object, e As KeyEventArgs) Handles btnAllName.KeyDown, btnAllCategory.KeyDown, btnAllDescription.KeyDown, btnAllManaged.KeyDown,
            btnAllNameType.KeyDown, btnAllCategoryType.KeyDown, btnAllDeleteProfile.KeyDown, btnAllSignatureGateway.KeyDown, btnAllSignatureDNS.KeyDown, btnAllDescription.KeyDown,
